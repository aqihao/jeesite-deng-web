 ...
 */
@Controller
@RequestMapping(value = "deng/index")
public class index extends BaseController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("classTab", "欢迎");
        return "themes/default/modules/sys/index";
    }
    ...
    public String login(Model model) {
        ...
        model.addAttribute("classTab", "欢迎");
        return "themes/default/modules/sys/login";
    }
    ...
    public String register(Model model){
        model.addAttribute("ret","注册");
        return "themes/default/modules/sys/register";
    }

    @RequestMapping(value = "know")
    public String know(Model model){
        model.addAttribute("ret","注册");
        return "themes/default/modules/sys/know";
    }
