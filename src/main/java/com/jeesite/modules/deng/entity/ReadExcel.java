            ...
            for (int c = 0; c < this.totalCells; c++) {
                ...
                if (null != cell) {
                    if (c == 0) {
                        ...
                        if (cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
                            String age = String.valueOf(cell.getNumericCellValue());
                            map.put("img", age.substring(0, age.length() - 3 > 0 ? age.length() - 3 : 1));// 照骗
                        } else {
                            map.put("img", cell.getStringCellValue());// 照骗
                        }
                    } else if (c == 4) {
                        if (cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
                            String age = String.valueOf(cell.getNumericCellValue());
                            map.put("resume", age.substring(0, age.length() - 4 > 0 ? age.length() - 4 : 1));// 简历
                        } else {
                            map.put("resume", cell.getStringCellValue());// 简历
                        }
                    }
                }
            }
